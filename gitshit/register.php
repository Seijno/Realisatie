...
if(isset($_POST["submit"])){
    ...
    $admin = $_POST["admin"] == 1 ? $_POST["admin"] : 0; 
  
    $userArray = array(":usr" => $user, ":eml" => $email, ":pwd" => $password, ":adm" => $admin);
  
    $sql = "INSERT INTO `user` (`username`, `email`, `password`, `admin`)
            VALUES (:usr, :eml, :pwd, :adm);";
...
<main class="form-signin">
  <form method="POST" action="">
    ...
    <div class="form-floating">
      <input type="checkbox" name="admin" action="admin" id="admin" value="1">
      <label for="floatingInput">Bent u een admin?</label>
    </div>
    <div class="py-5">
